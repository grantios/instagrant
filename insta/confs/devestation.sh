# Devestation configuration file for Arch Linux installation
...
export CONFIG_NAME="devestation"
...
export GPU_DRIVER="nvidia-open"  # auto, nvidia, nvidia-lts, nvidia-open, amd, intel, modesetting

# Boot configuration
export LEGACY_BOOT="true"  # Set to true for legacy BIOS/CSM systems (uses GRUB on /boot)
