# Default configuration file for Arch Linux installation
...
EXTRA_PACKAGES=(
    "flatpak" "podman" "distrobox" "qemu-full"
    "unzip" "exfat-utils" "ntfs-3g" "net-tools"
    ...
    "llvm" "lldb" "clang" "cmake" "meson" "ninja" "sbcl" "roswell" "racket" "fennel"
)
AUR_PACKAGES=(
...
export SERVICES="syncthing@STEIN.service"  # Uncomment to enable Syncthing user service
